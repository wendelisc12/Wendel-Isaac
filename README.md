...
Sou graduando em análise e desenvolvimento de sistemas, atualmente estou realizando pesquisas na área de front-end. Sou um desenvolvedor react apaixonado na criação de interfaces web, ao longo dos anos da minha graduação adquiri experiências com Python, AWS, Javascript, java, html, css, Node e React. Hoje em dia estou me especializando em React.
